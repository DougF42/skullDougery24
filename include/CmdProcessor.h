 ...
 * 
 * The stream buffering processing is local to each instance... 
 * We expect once instance per i/o stream (channel) that we can get commands from.
 * (Example :  USB Serial port, UDP or TELNET connection)
 *
 * The list of commands is the same regardless of the channel.
 * 
 */
